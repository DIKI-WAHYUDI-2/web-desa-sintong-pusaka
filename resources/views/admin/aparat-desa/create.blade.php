...
@section('title', 'Tambah Aparat Desa')
@section('page-title', 'Tambah Aparat Desa Baru')
@section('page-subtitle', 'Tambahkan data aparat desa baru')

@section('content')
    <div class="mx-auto max-w-6xl">
        <form id="aparat-form" action="{{ route('aparat_desa.store') }}" method="POST" enctype="multipart/form-data"
            class="space-y-6">
            @csrf
                        ...
                        <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" id="jabatan" name="jabatan" value="{{ old('jabatan') }}"
                                    class="admin-input h-12 rounded-xl" placeholder="Contoh: Sekretaris Desa" required>
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="date" id="mulai_jabatan" name="mulai_jabatan"
                                    value="{{ old('mulai_jabatan') }}" class="admin-input h-12 rounded-xl" required>
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="date" id="akhir_jabatan" name="akhir_jabatan"
                                    value="{{ old('akhir_jabatan') }}" class="admin-input h-12 rounded-xl">
                    ...
                    <div class="admin-card rounded-3xl p-6">
                        ...
                        <div class="mb-4 flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-sm text-muted-foreground">Gunakan foto formal dan jelas</p>
                            </div>
                        ...
                        <div class="mb-4 flex justify-center">
                            <div id="preview-container"
                                class="flex h-40 w-40 items-center justify-center overflow-hidden rounded-full border border-border bg-muted">

                                <div id="preview-placeholder" class="text-center text-muted-foreground">
